...
abstract class AbstractDb extends \Zend\Db\TableGateway\TableGateway
{
     ...
     *
     * @example \App\Entity\News
     * @var string
     */
    protected $entityClassName = '\App\Entity\Record';
    ...
    function initialize()
    {
        ...
        {
            $this->table = new \Zend\Db\Sql\TableIdentifier("{$prefix}{$tableName}", $this->schemaName);
        }
        else
        {
    ...
    /**
     * Returns a ResultSet of \App\Entity\Record
     *
     ...
     */
    function findBy($where = null, array $cols = array(), $order = null, $count = null, $offset = null, App\Entity\AbstractEntity $entity = null)
    {
        $sql = $this->getSql();
        $select = $sql->select();
        ...
        if(empty($entity))
        {
            $entity = $this->getServiceLocator()->get($this->entityClassName);
        }
     ...
     *
     * @param string $order
     * @param App\Entity\Record $entity
     * @return Zend\Db\ResultSet\AbstractResultSet
     */
    function findAll($order = null, App\Entity\Record $entity = null)
    {
     ...
     * @param App\Entity\Record $entity
     * @return App\Entity\AbstractEntity | null
     */
    function findByPrimaryKey($mixed, $colName = null, App\Entity\AbstractEntity $entity = null)
    {
        if(! is_array($mixed))
        {
            if(empty($colName))
     ...
     */
    function executeCustomSelect(\Zend\Db\Sql\Select $select, \App\Entity\AbstractEntity $entity = null)
    {
        // prepare and execute
        ...
        {
            $sl = $this->getServiceLocator();
            $entity = $sl->get('App\Entity\Record');
        }
